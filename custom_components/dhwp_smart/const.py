...
CONF_WATER_HEATER_ENTITY = "water_heater_entity"   # legacy — kept for backward-compat; no longer used
CONF_BOOST_DURATION_ENTITY = "boost_duration_entity"   # number entity, Atlantic Cozytouch boost duration (days)
...
CONF_HEATER_NOMINAL_W = "heater_nominal_w"
...
DEFAULT_BOOST_TARGET_C = 55.0   # legacy, unused
DEFAULT_BOOST_DURATION_ENTITY = "number.dhwp_actuator_boost_mode_duration"
DEFAULT_BOOST_DURATION_DAYS = 1   # value to set when activating boost (max=7)
DEFAULT_SIGNAL_MIN_HOLD_MINUTES = 120
DEFAULT_HEATER_NOMINAL_W = 650.0  # measured Atlantic DHWP heat-pump draw
...
__all__ = [
    ...
    "CONF_BOOST_TARGET_C", "CONF_BOOST_DURATION_ENTITY",
    "CONF_SIGNAL_MIN_HOLD_MINUTES", "CONF_HEATER_NOMINAL_W",
    ...
    "DEFAULT_BOOST_TARGET_C", "DEFAULT_BOOST_DURATION_ENTITY",
    "DEFAULT_BOOST_DURATION_DAYS",
    "DEFAULT_SIGNAL_MIN_HOLD_MINUTES", "DEFAULT_HEATER_NOMINAL_W",
